...
class Record_results(object):
    ...
    def __init__(self, gold_file, system_file):
        ...
        self.tags = ("Addictive Behavior", "Age", "Allergy Intolerance", "Compliance with Protocol", "Consent", "Diagnostic", "Disease", "Enrollment in other studies", "Laboratory Examinations", "Life Expectancy", "Organ or Tissue Status", "Pharmaceutical Substance or Drug", "Risk Assessment", "Smoking Status", "Therapy or Surgery")
...
class Evaluation(object):
    ...
    def show_results(self):
        print('{:*^100}'.format(' Evaluation Results '))
